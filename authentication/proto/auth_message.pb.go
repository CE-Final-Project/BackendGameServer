...
func (x *VerifyTokenRes) GetAccountID() uint64 {
	if x != nil {
		return x.AccountID
	}
	return 0
...
func (x *RegisterRes) GetAccountID() uint64 {
	if x != nil {
		return x.AccountID
	}
	return 0
...
var file_auth_message_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x04, 0x52, 0x09, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x44, 0x12, 0x1a,
