...
func (x *SearchRes) Reset() {
	*x = SearchRes{}
	if protoimpl.UnsafeEnabled {
		mi := &file_auth_message_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SearchRes) Descriptor() ([]byte, []int) {
	return file_auth_message_proto_rawDescGZIP(), []int{12}
}
...
var file_auth_message_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x44, 0x22, 0x4b, 0x0a, 0x09, 0x53, 0x65, 0x61, 0x72, 0x63,
	0x68, 0x52, 0x65, 0x71, 0x12, 0x16, 0x0a, 0x06, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x18, 0x01,
	...
	0x73, 0x69, 0x7a, 0x65, 0x22, 0xc2, 0x01, 0x0a, 0x09, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x52,
	...
	0x08, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x42, 0x10, 0x5a, 0x0e, 0x2e, 0x2f, 0x3b,
...
var file_auth_message_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_auth_message_proto_goTypes = []interface{}{
	...
	(*SearchReq)(nil),             // 11: authentication.SearchReq
	(*SearchRes)(nil),             // 12: authentication.SearchRes
...
var file_auth_message_proto_depIdxs = []int32{
	...
	13, // 2: authentication.UpdateAccountRes.UpdatedAt:type_name -> google.protobuf.Timestamp
	0,  // 3: authentication.SearchRes.Accounts:type_name -> authentication.Account
...
func file_auth_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_auth_message_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_auth_message_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
